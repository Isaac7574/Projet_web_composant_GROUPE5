...
package local_project.ods_categorie_0_1;
...
/**
 * Job: ODS_Categorie Purpose: ODS_Categorie<br>
 * Description: ODS_Categorie <br>
 * 
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status
 */
public class ODS_Categorie implements TalendJob {
	...
	private final String jobName = "ODS_Categorie";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					ODS_Categorie.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ODS_Categorie.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String directory_tFileList_1 = "C:/Users/1/Downloads";
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					globalMap.put("tDie_1_DIE_MESSAGE", "ERREUR");
					globalMap.put("tDie_1_DIE_MESSAGES", "ERREUR");
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_ODS_Categorie = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_ODS_Categorie = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_ODS_Categorie.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_ODS_Categorie.length == 0) {
						commonByteArray_LOCAL_PROJECT_ODS_Categorie = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_ODS_Categorie = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_ODS_Categorie, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_ODS_Categorie, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_ODS_Categorie, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_ODS_Categorie, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_ODS_Categorie) {
...
// ###############################
				...
				try {
					...
					Object filename_tFileInputDelimited_1 = ((String) globalMap.get("tFileList_1_CURRENT_FILE"));
					...
					try {
						fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
								((String) globalMap.get("tFileList_1_CURRENT_FILE")), "UTF-8", ",", "\n", true, 1, 0,
...
// ###############################
					...
					if (!((Object) (((String) globalMap
							.get("tFileList_1_CURRENT_FILE"))) instanceof java.io.InputStream)) {
...
// ###############################      
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:KcoXf6GSIjgjnD0ifq6bPp+90e7hJaOxyG/Ifopk4GE=");
	...
	public void tSetGlobalVar_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				globalMap.put("masque_fichier", "categorie.csv");
	...
	public static void main(String[] args) {
		final ODS_Categorie ODS_CategorieClass = new ODS_Categorie();

		int exitCode = ODS_CategorieClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ODS_Categorie.class.getClassLoader()
					.getResourceAsStream("local_project/ods_categorie_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ODS_Categorie.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ODS_Categorie");
		}
...
/************************************************************************************************
 * 69763 characters generated by Talend Open Studio for Data Integration on the
 * 24 novembre 2025 à 12:16:56 GMT
 ************************************************************************************************/